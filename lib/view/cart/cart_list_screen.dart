                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text("Apple W-series 6",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500),overflow: TextOverflow.ellipsis,maxLines: 1,),
                                  SizedBox(height: 8,),
                                  Text("\$300",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 17),),
                                ],
                              ),
                            ),
                            SizedBox(width: 10,),
