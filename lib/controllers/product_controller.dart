...
class ProductController extends GetxController{
  ...
  addToCart(QueryDocumentSnapshot product){
    FirebaseFirestore.instance.collection('users').doc(user!.email).collection('cart').add({
      ...
      Get.snackbar('Success',  'Product successfully added to cart',colorText:Colors.black,);
    });
  }
}